const petData = [
  {
    id: 0,
    name: "Jennifer",
    image: "../assets/pets-jennifer.svg",
    type: "Dog - Labrador",
    age: 2,
    desc: "Jennifer is a sweet 2 months old Labrador that is patiently waiting to find a new forever home. This girl really enjoys being able to go outside to run and play, but won't hesitate to play up a storm in the house if she has all of her favorite toys. if she has all of her favorite toys.",
  },
  {
    id: 1,
    name: "Sophia",
    image: "../assets/pets-shopia.svg",
    type: "Dog - Shih tzu",
    age: 2,
    desc: "Sophia here and I'm looking for my forever home to live out the best years of my life. I am full of energy. Everyday I'm learning new things, like how to walk on a leash, go potty outside, bark and play with toys and I still need some practice. e has all of her favorite toys.",
  },
  {
    id: 2,
    name: "Woody",
    image: "../assets/pets-woody.svg",
